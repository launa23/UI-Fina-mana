...
public class StatisticByMonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_statistic_by_month, container, false);
        barChart = rootView.findViewById(R.id.barChartInChartByMonth);
        progressBar = rootView.findViewById(R.id.progressInMonth);
        ...
        for (int i = 0; i < 7; i++) {
            ...
            calendar.add(Calendar.MONTH, -1); // Giảm 1 ngày
        }
        ...
        Call<List<StatisticByDayDTO>> call = ApiService.getInstance(getActivity()).getiApiService().getStatisticByDay("thisMonth");
